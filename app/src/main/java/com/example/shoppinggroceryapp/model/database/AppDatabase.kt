...
import com.example.shoppinggroceryapp.model.entities.deals.DealsEntity
import com.example.shoppinggroceryapp.model.entities.help.CustomerRequestEntity
import com.example.shoppinggroceryapp.model.entities.help.FAQEntity
...
//        PREPOPULATED DATA WHEN THE DATABASE IS INSTALLED
        ...
        var productEntityLists = listOf(ProductEntity(productId=1, brandId=21, categoryName="Fresh Fruits", productName="Apples", productDescription="Fresh red apples", price=120.0f, offer=10.0f, productQuantity="1 kg", mainImage="1725857406264", isVeg=true, manufactureDate="2024-08-01", expiryDate="2024-08-15", availableItems=120)
            ...
            ,ProductEntity(productId=43, brandId=21, categoryName="Fresh Vegetables", productName="Salem Mangoes", productDescription="Crisp cucumbers", price=50.0f, offer=-1.0f, productQuantity="1 kg", mainImage="1725625346396", isVeg=true, manufactureDate="2024-09-14", expiryDate="2024-09-21", availableItems=141)
        ...
        var brandList = listOf(BrandDataEntity(brandId=1, brandName="Amul")
